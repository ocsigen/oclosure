...
let _ =
  ...
  and counter1 = Js.get_element_by_id "counter1" in 
    ignore(new Charcounter.charcounter input1 counter1 160. 0);

  let input2 = Js.get_element_by_id "input2"
  and counter2 = Js.get_element_by_id "counter2" in
    ignore(new Charcounter.charcounter input2 counter2 160. 1);
  ...
  let test = new Charcounter.charcounter input3 counter3 10. 0 in
  ...
  let counter4 = Js.get_element_by_id "counter4" in
    ignore(new Charcounter.charcounter input4 counter4 255. 0);
