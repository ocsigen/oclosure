...
type window = JSOO.obj (*TODO : Check this type *)
...
class external dom : 
 ...
 (* TODO: Check this function with the window element*)
 ...
 (* TODO: Check this functon with its second element*)
 setProperties: element -> element -> unit;
 
 (** Cross browser function for setting the text content 
     of an element **)
