...
let tooltip1 = jsnew Goog.Ui.Tooltip.tooltip(
  Js.some (id (Js.string "btn1")), 
  Js.some (Js.string msg1), Js.null)
  
let tooltip2 = jsnew Goog.Ui.Tooltip.tooltip(
...
let tooltip3 = jsnew Goog.Ui.Tooltip.tooltip(
