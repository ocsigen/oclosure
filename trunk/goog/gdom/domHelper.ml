...
class type domHelper = object
 ...
 (** Returns a dom node with a set of attributes. 
  ...
  method createDom: js_string Js.t -> js_string Js.t Js.opt -> js_string Js.t opt -> Dom_html.element t meth
 ...
 (** Finds the first descendant node that matches the filter function.
  ...
  method findNode: #Dom.node t -> (#Dom.node t -> bool t) -> node t meth
 ...
 (** Walks up the DOM hierarchy returning the first ancestor
  ...
  method getAncestor: #Dom.node t -> (#Dom.node t -> bool t) -> bool t -> int opt -> node t meth
 ...
 (** Walks up the DOM hierarchy returning the first ancestor 
  ...
  method getAncestorByTagNameAndClass: #Dom.node t -> js_string Js.t -> js_string Js.t -> node t meth
 ...
 (** Returns the first child node that is an element *)
  method getFirstElementChild: #Dom.node t -> node t meth
 ...
 (** Returns the next node in source order from the given node **)
  method getNextNode: #Dom.node t -> node t meth
 ...
 (** Returns the text length of the text contained in a node, without markup. 
  ...
  method getNodeTextLength: #Dom.node t -> number meth
 ...
 (** Returns the text offset of a node relative to one of its ancestors.
  ...
  method getNodeTextOffset: #Dom.node t -> node t -> number meth
 ...
 (** Inserts a new node after an existing reference node
  ...
  method insertSiblingAfter: #Dom.node t -> node t meth
 
 (** Inserts a new node before an existing reference node
     (i.e., as the next sibling).
     If the reference node has no parent, then does nothing. *)
  method insertSiblingBefore: #Dom.node t -> node t meth
 ...
 (** Removes a node from its parent. *)
  method removeNode: #Dom.node t -> node t meth
