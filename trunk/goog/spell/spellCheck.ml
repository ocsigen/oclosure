...
type wordEntry = Js.Unsafe.any js_array t (* FIX: should be abstract *)
 ...
 *)
  method setWordStatus :
      js_string t -> int -> js_string t js_array t -> unit meth
end

let spellCheck = Js.Unsafe.variable "goog.spell.SpellCheck"
