...
let create (e : element t) (w : int) (h : int) (bw : int) (r : int) (l : int) (bc : js_string t) (bgc : js_string t opt) (hp : Gdom.DomHelper.domHelper t opt) : abstractImagelessRoundedCorner t optdef =
  Js.Unsafe.fun_call
