...
class type container = object
  ...
  *)
  method getKeyHandler : KeyHandler.keyHandler t meth 
...
*)
  ...
  *)
  ...
  (**
     ...
     the event.
  *)
  method handleEnterItem : Event.event t -> bool t meth 
  ...
  *)
  method handleOpenItem : #Event.event t -> unit meth 
  ...
  *)
  method handleCloseItem : #Event.event -> unit meth 
  ...
  *)
  method handleMouseDown : #BrowserEvent.browserEvent t -> unit meth 
  ...
  *)
  method handleDocumentMouseUp : #BrowserEvent.browserEvent t -> unit meth 
  ...
  *)
  method handleChildMouseEvents : #BrowserEvent.browserEvent t -> unit meth 
  ...
  *)
  method handleBlur : #BrowserEvent.browserEvent t -> unit meth 
  ...
  *)
  method handleKeyEvent : KeyEvent.keyEvent t -> bool t meth 
  ...
  (**
     ...
     its children).
  *)
  method handleKeyEventInternal : KeyEvent.keyEvent t -> bool t meth 
